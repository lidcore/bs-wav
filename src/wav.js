...
var buf = Buffer$LidcoreBsNode.from(undefined, " ");

function input_byte(ic) {
  var partial_arg = ic.fd;
  return BsAsyncMonad.Callback[/* >> */3]((function (param) {
                return Fs$LidcoreBsNode.read(undefined, undefined, undefined, partial_arg, buf, param);
              }), (function (param) {
                if (param[0] !== 1) {
                  throw [
...
function read_float_num_bytes(ic, len) {
  ...
  return BsAsyncMonad.Callback[/* fold_lefti */19](undefined, (function (cur, idx, param) {
                return BsAsyncMonad.Callback[/* >> */3](input_byte(ic), (function (b) {
...
function read_int(ic) {
  return BsAsyncMonad.Callback[/* >> */3](read_float_num_bytes(ic, 4), (function (ret) {
...
function read_short(ic) {
  return BsAsyncMonad.Callback[/* >> */3](read_float_num_bytes(ic, 2), (function (ret) {
                var partial_arg = ret | 0;
                var partial_arg$1 = BsAsyncMonad.Callback[/* return */0];
                return (function (param) {
                    return partial_arg$1(partial_arg, param);
...
function read_string(ic, n) {
  ...
  return BsAsyncMonad.Callback[/* >> */3]((function (param) {
                ...
                var partial_arg = Buffer$LidcoreBsNode.toString(undefined, undefined, undefined, param[1]);
                var partial_arg$1 = BsAsyncMonad.Callback[/* return */0];
                return (function (param) {
                    return partial_arg$1(partial_arg, param);
                  });
...
function find_chunk(ic, id) {
  return BsAsyncMonad.Callback[/* >> */3](read_string(ic, 4), (function (ret) {
                var chunk_header = /* record */[/* contents */ret];
                ...
                return (function (param) {
                    return partial_arg((function (param) {
                                  ...
                                  return BsAsyncMonad.Callback[/* >> */3](read_int(ic), (function (len) {
...
function read(fd) {
  ...
  var remaining_fmt_len = /* record */[/* contents */-1];
  var format_code = /* record */[/* contents */-1];
  var chan_num = /* record */[/* contents */-1];
  var samp_hz = /* record */[/* contents */-1];
  var byt_per_sec = /* record */[/* contents */-1];
  var byt_per_samp = /* record */[/* contents */-1];
  var bit_per_samp = /* record */[/* contents */-1];
  var ic = {
    fd: fd,
    offset: 0
  };
  ...
  if (remaining_fmt_len[0] > 0) {
    ...
    var partial_arg$4 = BsAsyncMonad.Callback[/* return */0];
    tmp = (function (param) {
        return partial_arg$4(/* () */0, param);
      });
  }
  return BsAsyncMonad.Callback[/* >> */3](BsAsyncMonad.Callback[/* seqa */26](undefined, /* array */[
                  BsAsyncMonad.Callback[/* >> */3](read_string(ic, 4), (function (ret) {
                  ...
                  find_chunk(ic, "fmt "),
                  BsAsyncMonad.Callback[/* >> */3](read_int(ic), (function (ret) {
                  ...
                  BsAsyncMonad.Callback[/* >> */3](read_short(ic), (function (code) {
                          format_code[0] = code;
                  ...
                  BsAsyncMonad.Callback[/* >| */7](read_short(ic), (function (ret) {
                          chan_num[0] = ret;
                          return /* () */0;
                        })),
                  BsAsyncMonad.Callback[/* >| */7](read_int(ic), (function (ret) {
                          samp_hz[0] = ret;
                          return /* () */0;
                        })),
                  BsAsyncMonad.Callback[/* >| */7](read_int(ic), (function (ret) {
                ...
                return BsAsyncMonad.Callback[/* >| */7](read_int(ic), (function (length) {
                              var header = {
                                channels: chan_num[0],
...
function read$1(path) {
  return BsAsyncMonad.Callback[/* >> */3]((function (param) {
                ...
                return BsAsyncMonad.Callback[/* &> */9](read(fd), (function (param) {
                              return (function (param) {
      ...
      return BsAsyncMonad.Callback[/* >> */3]((function (param) {
                    ...
                    var write = function (param, param$1) {
                      ...
                      if (data[0] >= 86585632) {
                        ...
                        match = /* tuple */[
                          data$2.length,
                          Buffer$LidcoreBsNode.from("binary", data$2)
                        ];
                      }
                      var buf = match[1];
                      var len = match[0];
                      return BsAsyncMonad.Callback[/* repeat */13]((function (param) {
                                    ...
                                    var partial_arg = offset;
                                    return BsAsyncMonad.Callback[/* >> */3]((function (param) {
                                                  return Fs$LidcoreBsNode.write(undefined, partial_arg, undefined, fd$1, buf, param);
                                                }), (function (param) {
                    ...
                    return BsAsyncMonad.Callback[/* &> */9](BsAsyncMonad.Callback[/* seqa */26](undefined, /* array */[
                                    (function (param) {
